...
sig1_T_ult = 1e6*normrnd(1500, 1500*sd/100);
sig1_C_ult = 1e6*normrnd(1500, 1500*sd/100);
sig2_T_ult = 1e6*normrnd(40, 40*sd/100);
sig2_C_ult = 1e6*normrnd(246, 246*sd/100);
tau12_ult = 1e6*normrnd(68, 68*sd/100);
