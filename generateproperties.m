...
E11 = 1e9*normrnd(181, 181*sd/100); %1e9*normrnd(16.48, 0.61);
E22 = 1e9*normrnd(10.30, 10.30*sd/100); %1e9*normrnd(1.4, 0.05);
G12 = 1e9*normrnd(7.17, 7.17*sd/100); %1e9*normrnd(0.87, 0.052);
v12 = normrnd(0.28, 0.28*sd/100); %normrnd(0.334, 0.01);
dtheta = normrnd(0, 50*sd/100); % 0.5deg sd per point
t = normrnd(0.025, 0.025*sd/100);
